---
linkTitle: "Upgrade SW360 from 17.0 to 19.1.0"
title: "Upgrade SW360 from 17.00 to 19.1.0"
weight: 100
---

[Version of libraries](#ref1)

[Checkout source code SW360 to Tag Version 19.1.0](#ref2)
...
## Prepare source code to use release 19.1.0 {#ref2}

Link contains source: <https://github.com/eclipse/sw360.git>

Create folder to store new source code of version 19.1.0:
...
Checkout to tag Version 19.1.0

```sh
$ git checkout sw360-19.1.0-M1
```
